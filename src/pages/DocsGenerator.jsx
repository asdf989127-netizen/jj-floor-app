...
${accLine}`.trimEnd();
    ...
    // ✅ 其他配件或材料（有輸入才顯示）
    const otherLine = (f.otherItems || "").trim() ? `\n其他配件或材料：${f.otherItems.trim()}\n` : "";
          ...
          <Card title="基本資訊">
            <TwoCol>
              ...
              <Field
                ...
                value={f.otherItems}
                onChange={(v) => setField("otherItems", v)}
                placeholder="例如：矽利康*2、收邊條*3、特殊轉角、搬運板車…"
              />
            </TwoCol>
          </Card>
